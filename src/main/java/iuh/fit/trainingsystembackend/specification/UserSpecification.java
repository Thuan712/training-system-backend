    ...
    public Specification<UserEntity> getFilter(UserRequest request) {
        return (root, criteriaQuery, criteriaBuilder) ->
                Specification.where(attributeContains("username", request.getUsername()))
                        ...
                        // Filter
                        .and(attributeContains("code", request.getSearchValue()).or(attributeContains("firstName", request.getSearchValue()).or(attributeContains("lastName", request.getSearchValue()))))
